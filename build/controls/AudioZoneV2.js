...
class AudioZoneV2 extends control_base_1.ControlBase {
    async loadAsync(type, uuid, control) {
        ...
        await this.createSimpleControlStateObjectAsync(control.name, uuid, control.states, 'clientState', 'number', 'volume', { states: clientStates });
        ...
        await this.createSimpleControlStateObjectAsync(control.name, uuid, control.states, 'volume', 'number', 'level.volume', {
            write: true,
        });
