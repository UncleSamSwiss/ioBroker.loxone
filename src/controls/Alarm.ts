import { StateValue } from '../main';
import { ControlBase } from './ControlBase';

export class Alarm extends ControlBase {
    async loadAsync(type: string, uuid: string, control: any): Promise<void> {
        ...
        this.addStateChangeListener(
            uuid + '.armed',
            (oldValue: StateValue | null | undefined, newValue: StateValue | null) => {
                if (newValue) {
